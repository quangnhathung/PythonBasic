# Viết hàm trộn 2 mảng một chiều thành 1 mảng một 
# chiều với mỗi phần tử của mảng mới 
# là tổng của 2 phần tương ứng từ 2 mảng cho trước.
# Trong quá trình trộn 2 mảng nếu mảng 
